...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.iroh": "Gateway Iroh Transport",
  "gateway.iroh.enabled": "Gateway Iroh Enabled",
  "gateway.iroh.secretKeyPath": "Gateway Iroh Secret Key Path",
  "gateway.iroh.relayMode": "Gateway Iroh Relay Mode",
  "gateway.iroh.relayUrls": "Gateway Iroh Relay URLs",
